...
export class Signup {
  ...
  correctInput(): boolean {
    ...
    if (!this.username || !this.email || !this.password || !this.confirmPassword) {
      fehlermeldung += 'Bitte alle Felder ausfuellen\n';
    }
    ...
    if (!this.emailRegex.test(this.email.trim())) {
      fehlermeldung += 'Bitte eine gueltige E-Mail eingeben (z. B. name@domain.de)\n';
    }
    ...
    if (this.password !== this.confirmPassword) {
      fehlermeldung += 'Passwoerter stimmen nicht ueberein\n';
    }
